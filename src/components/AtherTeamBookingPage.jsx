...
import { getAtherTeamMemberById, getAvailableAtherTeamSlots, createAtherTeamBooking } from '../lib/atherTeamBooking';
import LazyImage from './LazyImage';

export default function AtherTeamBookingPage() {
    ...
    const loadMemberAndSlots = async () => {
        try {
            setLoading(true);
            const memberData = await getAtherTeamMemberById(memberId);
            const slotsData = await getAvailableAtherTeamSlots(memberData.event_id, memberId);
    ...
    const handleSubmitBooking = async (e) => {
        ...
        try {
            await createAtherTeamBooking({
                slot_id: selectedSlot.id,
                ather_team_member_id: memberId,
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-6">
                <div className="text-center bg-white rounded-2xl shadow-xl p-10 max-w-md">
                    ...
                    <p className="text-gray-600 mb-6">Your interview with {member.name} has been booked successfully.</p>
                </div>
            </div>
        );
    }
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
                <div className="max-w-lg mx-auto">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Confirm Your Interview</h2>
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 mb-2">Book an Interview with {member.name}</h1>
